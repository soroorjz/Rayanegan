  ...
  return (
    <div className="login-container">
      ...
      <div className="login-right">
        ...
        <p>با ورود به حساب کاربری، اطلاعات شخصی خود را به‌روز کنید، سوابق آزمون‌های خود را مشاهده کنید و وضعیت ثبت‌نام را بررسی کنید. همچنین به کارت ورود، اطلاعات ثبت‌نامی و اعلان‌های مهم دسترسی داشته باشید و مراحل ثبت‌نام خود را مدیریت کنید.</p>
      </div>
    </div>
  );
};
