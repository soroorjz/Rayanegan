...
//     .string()
//     .matches(/^09[0-9]{9}$/, "شماره تلفن نامعتبر است")
//     //.required("شماره تلفن را وارد کنید"), // حذف الزام ورود شماره تلفن
//   postalCode: yup
//     .string()
//     .matches(/^\d{10}$/, "کد پستی باید ۱۰ رقم باشد")
//     //.required("کد پستی را وارد کنید"), // حذف الزام ورود کد پستی
//   province: yup.string()//.required("استان را انتخاب کنید"), // حذف الزام انتخاب استان
//   city: yup.string()//.required("شهر را وارد کنید"), // حذف الزام ورود شهر
//   address: yup.string()//.required("آدرس را وارد کنید"), // حذف الزام ورود آدرس
// });
